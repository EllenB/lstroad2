...
// https://www.tandfonline.com/doi/full/10.1080/10106049.2025.2465452#d1e297
...
// 1. AREA OF INTEREST 
//////////////////////////////////////////////////////////////
// The variable "chennai" is imported through uploading a shape file
...
// https://github.com/EllenB/lstroad/blob/main/notebooks/01_data_clean_chennai_a.ipynb

print('Bangalore', chennai);
print('The number of wards in Chennai');
print(chennai.size());
var chennaiGeometry = chennai.union(50);
Map.centerObject(chennaiGeometry);

// Visualisation - Outline only of Chennai
var empty = ee.Image().byte();
var chennaiOutline = empty.paint({
    featureCollection: chennaiGeometry,
    color: 1,
    width: 2
});

// Display Chennai boundary in red.
Map.addLayer(chennaiOutline,{palette: '#FF0000'},'Chennai boundary');

// Display the wards
var wardsOutline = empty.paint({
  featureCollection: chennai,
  color: 1,
  width: 2
});
Map.addLayer(wardsOutline, {palette: '#0000FF'}, 'Chennai Wards');

// Add also the wards map itself as you can use that with
// the inspector tool
Map.addLayer(chennai, {}, 'chennai wards');
///////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// 5. VISUALISATION OF THE INDICES
//////////////////////////////////////////////////////////////////////
// NDVI
var ndviVis = {
  min: 0,
...
Map.addLayer(
  ee.Image().byte().paint({
    featureCollection: chennai,  // original ward polygons
    color: 1,
    width: 2
  }),
...
Map.addLayer(
  ...
  {min: -0.1, max: 0.05, palette: ['white', 'red']},
  'Mean NDBI per ward'
);
Map.addLayer(
  ee.Image().byte().paint({
...
Map.addLayer(
  ...
  {min: -0.07, max: 0.12, palette: ['white', 'brown']},
  'Mean BSI per ward'
);
Map.addLayer(
  ee.Image().byte().paint({
