...
// the inspector tool
Map.addLayer(chennai, {}, 'Chennai wards - feature collection');
...
Export.table.toDrive({
    collection: LSTwards,
    description: 'lstermidasummer_chennai'
});
...
var chenBlocksPaint = empty.paint({
...
Map.addLayer(chenBlocksPaint.clip(chennaiGeometry), visParams,
    'LST means per ward');
